  ...
  return (
    <div>
      ...
      <form
        ...
        className="w-8/12 md:w-3/12 absolute p-8 md:py-10 md:px-12 bg-black my-28 md:my-28 mx-auto right-0 left-0 text-white rounded-md md:rounded-lg bg-opacity-80"
      >
