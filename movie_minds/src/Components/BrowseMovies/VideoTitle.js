...
const VideoTitle = ({ title, description }) => {
    return (
        <div className='w-full aspect-video pt-[6%] md:pt-[15%] px-6 md:px-24 absolute text-white bg-gradient-to-r from-black'>
            <h1 className='text-3xl md:text-5xl font-bold'>{title}</h1>
            <p className='py-3 md:py-6 text-[10px] leading-3 md:text-lg w-3/4 md:w-1/3'>{description}</p>
